...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!preg_match($starts_with, $question)) {
        $msg = "سوال درستی پرسیده نشده";
    }
} else {
...
<body>
    <p id="copyright">تهیه شده برای درس کارگاه کامپیوتر،دانشکده کامییوتر، دانشگاه صنعتی شریف، آذر ۱۴۰۰</p>
    <div id="wrapper">
        <div id="title">
        ...
        <div id="new-q">
            <form method="post">
                ...
                <select name="person">
                    <?php
                    $character = file_get_contents('people.json');
                    $names = json_decode($character);
